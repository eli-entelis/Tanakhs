        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Scientific = table.Column<int>(type: "int", nullable: false),
                    Historical = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HolyBook = table.Column<int>(type: "int", nullable: true),
                    ChapterNumber = table.Column<int>(type: "int", nullable: true),
                    ChapterChar = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ChapterRatingId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Verses_BlogPosts_ChapterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogPosts_ChapterRatingId",
                table: "BlogPosts",
